...
<head>
    ...
    <style>
        ...
        body { font-family: 'IPAGothic', sans-serif; font-size: 12pt; color: #1a1a1a; line-height: 1.6; margin: 0; padding: 0; }
        .page { padding: 40px 50px; }
        .header { border-bottom: 2px solid #e5e7eb; padding-bottom: 16px; margin-bottom: 24px; }
        h1, h2, h3, h4, h5, h6, strong, b, th { font-family: 'IPAGothic', sans-serif; font-weight: normal; }
        h1 { font-size: 22pt; margin: 0 0 8px 0; color: #111827; }
        ...
        .summary { font-size: 11pt; color: #4b5563; margin-bottom: 24px; padding: 12px 16px; border-left: 3px solid #d1d5db; background: #f9fafb; }
        ...
        .content code { background: #f3f4f6; font-size: 9pt; padding: 1px 4px; }
        .content pre { background: #f3f4f6; padding: 10px 12px; font-size: 9pt; margin-bottom: 12px; }
